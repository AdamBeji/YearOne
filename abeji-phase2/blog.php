                ...
                <form action = "addBlog.php" method="post" onsubmit="return Validate()">
                    <fieldset class = "form" id = "form">
                        <div class="form-group">
                            <input id = "text1" type="title" class="form-control" name="title" placeholder="Title"/>
                        </div>
                        <div class="form-group">
                            <textarea id = "text2" type = "text" class="form-control bcontent" name="content" placeholder="Enter your text here"></textarea>
                        </div>
                        <div class="form-group">
